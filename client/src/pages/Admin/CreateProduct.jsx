...
const CreateProduct = () => {
    ...
    useEffect(() => {
        localStorage.setItem("product_details", JSON.stringify({ name, description, price, quantity, shipping }));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${import.meta.env.VITE_SERVER}/api/v1/product/create-product`, productData);
            if (data?.success) {
            ...
            <div className='row'>
                ...
                <div className="col-md-9">
                    ...
                    <div className="m-1 w-75">
                        ...
                        <br />
                        <button className='btn btn-primary mb-5' onClick={handleSubmit}>Create Product</button>
                    </div>
                </div>
            </div>
        </Layout>
