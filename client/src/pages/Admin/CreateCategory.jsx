  ...
  const handleDelete = async (e) => {
    ...
    try {
      const { data } = await axios.delete(
        `/api/v1/category/delete-category/${deleted._id}`,
        { name: deleted?.name }
      );
      if (data.success) {
        toast.success(data.message);
      ...
      <div className="row">
        ...
        <div className="col-md-9">
          ...
          >
            ...
            <br />
            <p className="h6">
              Are you sure you want to delete category, "{deleted?.name}"?
            </p>
            <br />
            <button onClick={handleDelete} className="btn btn-primary me-2">
              OK
            </button>
            <button
              onClick={() => setDVisible(false)}
