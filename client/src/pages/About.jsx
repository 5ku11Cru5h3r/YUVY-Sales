    ...
    <Layout title={"Terms and Conditions"}>
      <div className="row contactus">
        <div className="col-md-3 ">
          <img src={about} className="container-fluid m-0" alt="contactus" id="Img" />
        </div>
        <div className="col-md-7">
          <p className="h1 text-justify mt-4">Terms and Conditions</p>
          <p className="h2 text-justify mt-4">
            These Terms and Conditions, along with privacy policy or other terms (“Terms”)
            constitute a binding agreement by and between UNNAT KUMAR AGARWAL, ( “Website Owner” or
            “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website,
            ...
            permitted by law.
            <br />
            Your use of our Services and the websiteis solely at your own risk and discretion.. You
            ...
            any authority to claim any intellectual property rights, title, or interest in its
            contents.
            <br />
            ...
            time, than this would make you ineligible for a refund.
            <br />
